          ...
          <tbody>
            {resData?.data.data.map((order, index) => (
              ...
              >
                ...
                <td className="p-4">
                  <select
                    className={`bg-[#1a1a1a] border p-2 rounded-lg focus:outline-none ${getStatusClass(
                      order.orderStatus
                    )}`}
                  ...
                  >
                    <option value="In Progress" className="text-yellow-400">
                      In Progress
                    </option>
                    <option value="Ready" className="text-green-400">
                      Ready
                    </option>
                    <option value="Done" className="text-blue-400">
                      Done
                    </option>
                  </select>
                </td>
